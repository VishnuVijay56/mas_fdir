...
def generate_launch_description():
	...
	ros_ns_str = ['px4_1', 'px4_2', 'px4_3', 'px4_4', 'px4_5', 'px4_6', 'cf_1', 'cf_2', 'cf_3', 'cf_4']
	...
	interagent_pub = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'gz_model_names': "[x500g_1, x500g_2, x500r_3, x500g_4, x500g_5, x500g_6, x500r_7, x500g_8, x500g_9, x500g_10]",
